...
The SquirrelNoise5 random noise function, originally by Squirrel Eiserloh.

See http://eiserloh.net/noise/SquirrelNoise5.hpp for the original C++ code.
"""
struct SquirrelNoise5
    seed::UInt32
end

function noise(n::Int32, s::SquirrelNoise5)
    ...
    # NB. ⊻ == bitwise xor (\xor to get the symbol)
    mangledbits = UInt32(n)
